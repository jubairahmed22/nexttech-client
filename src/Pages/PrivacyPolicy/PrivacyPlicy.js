    ...
    return (
        <div>
            ...
            <div className='policyPera lg:w-[1200px] md:w-[500px] sm:w-[200px]'>
              ...
              <h1 className='mt-10'><span className='itemsHeading'>6. Your Rights: </span><br/>You have the right to access, correct, or delete your personal information that we hold about you. You also have the right to object to or restrict the processing of your personal information. If you wish to exercise any of these rights, please contact us at  info@nexttechitc.com</h1>
              ...
              <h1 className='mt-10'><span className='itemsHeading'>10. Contact Us:</span> <br/>If you have any questions or concerns about our privacy policy or our use of your personal information, please contact us at  info@nexttechitc.com. We will respond to your inquiry as soon as possible.</h1>
              </div>
            </div>
            <Footer></Footer>
        </div>

...
const Slider = () => {
    const { slideData } = SliderDataHooks();
    ...
    return (
        <div className='mt-5 m-20 mb-5 card'>
            <h1 className='text-center mt-10 mb-5 heading'>What We <span className='text-orange-600'>Do</span></h1>
